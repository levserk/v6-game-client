...
};var m={disableInvite:!1,sounds:!0},n={close:"i/close.png",spin:"i/spin.gif",sortAsc:"i/sort-asc.png",sortDesc:"i/sort-desc.png",sortBoth:"i/sort-both.png",del:"i/delete.png"},o={start:{src:"audio/v6-game-start.ogg"},turn:{src:"audio/v6-game-turn.ogg",volume:.5},win:{src:"audio/v6-game-win.ogg"},lose:{src:"audio/v6-game-lose.ogg"},invite:{src:"audio/v6-invite.ogg"},timeout:{src:"audio/v6-timeout.ogg"}};return l}),define("v6-game-client",["client"],function(a){return console.log("main;",new Date,"ready"),a});